...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:NoelWatters256@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:NoelWatters256@localhost")  # No database specified
